 ...
 * @extends Gadget
 */
let GridArray$1 = class GridArray extends Gadget {
 ...
 * @extends GridArray
 */
class GridBucketArray extends GridArray$1 {
    static {
...
class HexArray extends GridArray$1 {
...
class Tiler extends Sketch {
    static {
        ...
        this.$schema('$grid', { parser: (o) => new GridArray$1({ cols:o.gridSize.x, rows:o.gridSize.y }) });
...
export { $TileOverlay, Animation, Animator, Asset, Autotiler, AutotilerMap, AutotilerTemplate, Bounds$1 as Bounds, CachingProperty, Contains, DependentProperty, Direction, Evt, EvtEmitter, Fmt$1 as Fmt, Gadget, GadgetArray, GadgetAssets, GadgetCtx, GadgetGenerator, GadgetProperty, Game, GameModel, GameState, Gizmo, Grid, Grid3Array, Grid3BucketArray, GridArray$1 as GridArray, GridBucketArray, Hex, HexArray, HexBucketArray, HexGrid, ImageMedia, Intersect, KeySystem, Mathf, Media, MouseSystem, Overlaps, Prng, Random, Rect, RenderSystem, Segment, Sfx, SfxSystem, Shape, SheetTemplate, Sketch, SketchMixer, Sprite, StateMgr, System, SystemMgr, Text, TextFormat, Ticker, Tiler, Timer, Tri, UiButton, UiCanvas, UiGrid, UiHorizontalSlider, UiHorizontalSpacer, UiInput, UiPanel, UiScroller, UiText, UiToggle, UiVerticalSlider, UiVerticalSpacer, UiView, Util, Vect$1 as Vect, Vect3, XForm };
